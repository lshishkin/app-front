...
import type { IComment } from "../../interfaces/main";
    ...
    <>
      <form className="card comment-form" onSubmit={onPostComment}>
        ...
        <div className="card-footer">
          <img src={data.image||USER_DEFAULT_IMG} className="comment-author-img" alt="comment-author" />
        ...
        <div className="card" key={index}>
          ...
          <div className="card-footer">
            <a href="/" className="comment-author">
              <img src={comment.author.image||USER_DEFAULT_IMG} className="comment-author-img" alt="comment-author" />
            </a>
            &nbsp;
            <a href="/" className="comment-author">
