...
import type { createArticleParam, createCommentParam, deleteArticleParam, deleteCommentParam, favoriteParam, getArticleParam, getArticlesParam, getCommentsParam, updateArticleParam } from "./articlesRepository.param";
